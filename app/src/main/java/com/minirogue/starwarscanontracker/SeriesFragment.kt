...
import com.minirogue.starwarscanontracker.database.Series
...
class SeriesFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewModel?.let {viewModel ->
            viewModel.liveSeries.observe(this, Observer { series -> updateViews(series, fragmentView) })
            viewModel.liveSeriesNotes.observe(this, Observer { notes -> updateViews(notes, fragmentView) })
