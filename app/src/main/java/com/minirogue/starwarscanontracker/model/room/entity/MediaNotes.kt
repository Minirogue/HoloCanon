...
@Entity(tableName = "media_notes", foreignKeys = [ForeignKey(entity = MediaItem::class, parentColumns = ["id"], childColumns = ["media_id"], onDelete = ForeignKey.CASCADE)])
class MediaNotes(@field:PrimaryKey
